...
describe('Space Age', () => {
  ...
  test('invalid planet', () => {
    const expectedError = 'Invalid planet: Zzz';
    expect(() => age('Zzz')).toThrow(expectedError);
  });

  test('invalid seconds', () => {
    const expectedError = 'Invalid seconds: a';
    expect(() => age('neptune', 'a')).toThrow(expectedError);
  });
});
